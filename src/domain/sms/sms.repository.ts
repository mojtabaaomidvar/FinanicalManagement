...
export interface SmsRepository {
  ...
  /** ثبت خام سمت سرور: یک متن پیامک را به /sms/ingest می‌فرستد و سرور خودش
      پارس و تشخیص می‌دهد بانکی هست یا نه. تعداد رکورد ساخته‌شده را برمی‌گرداند
      (۰ = پیامک بانکی نبود). فرستنده اختیاری است و برای تشخیص بانک کمک می‌کند. */
