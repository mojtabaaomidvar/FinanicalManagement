...
export function SettingsPage() {
  ...
  /** کلید «نمایش به ریال» — واحد نمایش خود همین کاربر (v5.8).
  ...
  */
  ...
  /* بازگشت دکمه/سوایپ در زیرصفحهٔ باز = برگشت به فهرست تنظیمات */
  ...
  /* ── به‌روزرسانی دیگر زیرصفحه ندارد (به‌خواست کاربر): بررسی و نصب
     مستقیماً روی ردیف «به‌روزرسانی» در فهرست اصلی انجام می‌شود. کارت
    ...
    <section className="page active">
      ...
      <div className="content set-page">
        ...
        <SettingsCard title="برنامه">
          ...
          />
          {/* به‌روزرسانی و درباره دو ردیف جدا شدند (§۶.۱). بررسی/نصب همه
              درجا روی همین ردیف انجام می‌شود — دیگر زیرصفحه‌ای باز نمی‌شود.
              نسخه و شناسهٔ ساخت هم زیر همین ردیف نوشته شده تا هنگام OTA
...
/* ── بازنشسته (به‌خواست کاربر): «کارت نسخه و به‌روزرسانی» که پیش‌تر در یک
   زیرصفحهٔ جدا باز می‌شد. حالا بررسی/نصب به‌روزرسانی درجا روی ردیف
