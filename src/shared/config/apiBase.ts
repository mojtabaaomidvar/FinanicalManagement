/* بازنشسته در فاز ۹ (سوییچ کامل و تمیز).
   ────────────────────────────────────────────────────────────────────────
   این ماژول «API_BASE» را می‌ساخت: در اپ نیتیو آدرس مطلق دپلوی Vercel و در وب
   رشتهٔ خالی (نسبی)، برای رساندن درخواست‌ها به توابع سرورلس. با مهاجرت به بک‌اند
   اختصاصی، مبدأ واحد به «shared/config/apiUrl» (API_URL + absoluteApiUrl) منتقل شد.
