/* نشان یک قلم بازار — لوگوی رمزارز، پرچم ارز، یا سکه/شمش طلا.
   ...
   چرا SVG دستی و نه تصویر؟ اپ آفلاین هم کار می‌کند و نباید برای ۲۰ کاشی
   ۲۰ درخواست شبکه بزند؛ ضمناً لوگوی برندها دارایی‌های حقوقی دیگران‌اند و
   جاسازی فایلشان در مخزن دردسر لایسنس دارد. این‌ها بازنمایی ساده‌شده‌اند:
   شکل و رنگ به‌قدری که در ۴۰ پیکسل یک‌نگاهی تشخیص داده شوند.
