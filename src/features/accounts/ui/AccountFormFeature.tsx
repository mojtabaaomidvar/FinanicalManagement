        ...
        {editing && m.balanceChanged ? (
          <div className="bal-warn" style={{ gridColumn: "1 / -1" }}>
            <div className="bal-warn-head">
              ...
              <b>این تغییر تراکنش ثبت نمی‌کند</b>
            </div>
            <p>
              موجودی به‌صورت دستی اصلاح می‌شود و هیچ درآمد یا هزینه‌ای برای آن
              ثبت نمی‌شود؛ در گزارش‌ها و بودجه‌ی این ماه دیده نخواهد شد. اگر پول
              واقعاً جابه‌جا شده، به‌جای این کار یک تراکنش ثبت کنید.
            </p>
